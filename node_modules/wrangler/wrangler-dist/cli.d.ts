...
export declare type Unstable_RawConfig = Partial<ConfigFields<RawDevConfig>> & PagesConfigFields & Unstable_RawEnvironment & EnvironmentMap & {
    $schema?: string;
};
 ...
 */
export declare type Unstable_RawEnvironment = Partial<Environment>;
